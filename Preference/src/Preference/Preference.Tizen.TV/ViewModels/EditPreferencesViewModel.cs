...
namespace Preference.ViewModels
{
    ...
    public class EditPreferencesViewModel : ViewModelBase
    {
        ...
        public event EventHandler<EventArgs> OnSaveCompleteEvent;

        public event EventHandler<EventArgs> OnLoadCompleteEvent;

        public event EventHandler<EventArgs> OnInvalidDataEvent;
